...
contract MexangaReceiver2 is CCIPReceiver {
    // -- Events -- //
    // Event emitted when a message is received from another chain
    event MessageReceived(
        bytes32 indexed messageId, // Unique ID of the message
        uint64 indexed sourceChainSelector, // Chain selector of the source chain
        address sender, // Address of the sender from the source chain
        string text // Text that was received
    );
